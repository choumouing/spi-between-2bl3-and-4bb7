...
> **修订说明**：v4.1 调整开发阶段顺序：先DMA优化，后多从机扩展
...
| 第二阶段：主机DMA优化 | ⏳ 待开始 | 主机端使用PDMA传输 |
| 第三阶段：从机DMA优化（可选） | ⏳ 待开始 | 从机端DMA优化（收益较小） |
| 第四阶段：多从机扩展 | ⏳ 待开始 | 扩展到3个从机 |

**阶段调整说明**（v4.1）：
- 原方案：先多从机扩展，后DMA优化
- 新方案：**先DMA优化，后多从机扩展**
- 调整理由：DMA是底层变化，先稳定底层再扩展上层；单从机环境下调试DMA变量最少
